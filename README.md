...
Current stable version: **v1.2.0**. See [CHANGELOG.md](CHANGELOG.md) for release details.
...
- macOS Apple Silicon (M1, M2, M3, M4): v1.2.0 `macOS-arm64`
- macOS Intel: v1.2.0 `macOS-x64`
- Windows 64-bit: v1.2.0 `Windows-x64`
