...
Current stable version: **v1.3.2**. See [CHANGELOG.md](CHANGELOG.md) for release details.
...
- macOS Apple Silicon (M1, M2, M3, M4): v1.3.2 `macOS-arm64`
- macOS Intel: v1.3.2 `macOS-x64`
- Windows 64-bit: v1.3.2 `Windows-x64`
